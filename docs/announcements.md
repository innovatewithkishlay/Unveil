...
Unveil can show dismissible announcements in the editor as a popup, carousel slide, lightweight live notification, or header banner. Popups can contain images or video; notifications and banners are text-only with optional buttons.
	...
	"announcements": [
		{
			...
			"title": "A faster Unveil is here",
			"body": "Exports are faster and cursor motion is smoother. Thanks for using Unveil!",
			"presentation": "popup",
			"audience": "editor",
			"priority": 10,
			"mediaMode": "cover",
			...
			"media": {
				...
				"alt": "Unveil 1.4 feature preview"
			},
			"action": {
				"label": "See what changed",
				"url": "https://github.com/innovatewithkishlay/Recordly/releases"
			}
		},
		{
