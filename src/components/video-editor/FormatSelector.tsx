				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#6D4FD1]/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
								? "bg-[#6D4FD1]/10 border-[#6D4FD1]/50 text-[#6D4FD1] dark:text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#6D4FD1]/20 text-[#6D4FD1]" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#6D4FD1]" />
						)}
					</button>
				);
			})}
