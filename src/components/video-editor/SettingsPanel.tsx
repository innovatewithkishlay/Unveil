					...
					return (
						<button
							...
							className={cn(
								...
								isActive &&
									"border-[#6D4FD1]/70 bg-[#6D4FD1]/12 shadow-[inset_0_0_0_1px_rgba(109, 79, 209,0.15)]",
							)}
						>
							<div className="flex items-start gap-3">
								<div
									className={cn(
										...
										isActive &&
											"border-[#6D4FD1]/30 bg-[#6D4FD1]/10 text-[#75A6FF]",
									)}
								>
					...
					return (
						<ToggleGroupItem
							...
							className={cn(
								...
								"data-[state=on]:border-[#6D4FD1]/70 data-[state=on]:bg-[#6D4FD1]/12 data-[state=on]:text-foreground",
							)}
						>
								...
								>
									{isActive ? (
										<motion.span
											...
											className="absolute inset-0 rounded-lg bg-[#6D4FD1]"
											transition={{
												type: "spring",
												stiffness: 420,
												damping: 34,
							...
							{backgroundTab === "image" ? (
								<div className="mt-0 space-y-2">
									...
									<Button
										...
										variant="outline"
										className="w-full gap-2 bg-foreground/5 text-foreground border-foreground/10 hover:bg-[#6D4FD1] hover:text-white hover:border-[#6D4FD1] transition-all h-7 text-[10px]"
									>
			...
			<div className="flex-[2] w-[332px] min-w-[280px] max-w-[332px] bg-editor-panel rounded-2xl flex flex-col shadow-xl h-full overflow-hidden">
				...
				>
					<div className="mb-4 flex items-center gap-2">
						<Palette className="w-4 h-4 text-[#6D4FD1]" />
			...
			<div className="rounded-lg bg-foreground/[0.03] px-2.5 py-2 space-y-3">
					...
					<div className="grid w-full grid-cols-2 gap-2">
						{whisperModelDownloadStatus === "downloading" ? (
							...
							<Button
								...
								className="h-10 w-full rounded-xl bg-[#6D4FD1] px-4 text-sm font-medium text-white hover:bg-[#6D4FD1]/90"
							>
				...
				<div className="flex flex-col gap-2">
					<Button
						...
						className="h-10 w-full rounded-xl bg-[#6D4FD1] px-4 text-sm font-medium text-white hover:bg-[#6D4FD1]/90 disabled:opacity-60"
					>
		...
		const settingsSectionContent = (
			<div className="space-y-4">
				...
				{showDevMotionControls ? (
					<section className="flex flex-col gap-2 rounded-xl border border-[#6D4FD1]/15 bg-[#6D4FD1]/5 p-3">
						<div className="flex items-center justify-between gap-3">
							<div>
								<SectionLabel>
						...
						<div className="rounded-lg border border-foreground/10 bg-background/60 px-3 py-3">
							<div className="flex items-start justify-between gap-3">
								...
								<Button
									...
									className="h-8 shrink-0 border-[#6D4FD1]/20 bg-[#6D4FD1]/10 text-[#6D4FD1] hover:bg-[#6D4FD1]/15"
								>
								...
								<button
									...
									className={cn(
										...
										selectedZoomMode === "auto"
											? "bg-[#6D4FD1] text-white shadow-sm"
											: "text-muted-foreground hover:text-foreground",
									)}
								>
								...
								return (
									<Button
										...
										className={cn(
											...
											isActive
												? "border-[#6D4FD1] bg-[#6D4FD1] text-white"
												...
												return (
													<button
														...
														className={cn(
															...
															isSelected
																? "border-foreground/80 ring-1 ring-[#6D4FD1]/50"
