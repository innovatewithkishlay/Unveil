				...
				<div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
					<div className="flex flex-shrink-0 items-center justify-center gap-2 py-1.5">
							...
							>
								{ASPECT_RATIOS.map((ratio) => (
									...
									>
										...
										{aspectRatio === ratio ? (
											<Check className="h-3 w-3 text-[#6D4FD1]" />
										) : null}
									</DropdownMenuItem>
								))}
							</DropdownMenuContent>
						...
						>
							...
							{isCropped ? (
								<span className="h-1.5 w-1.5 rounded-full bg-[#6D4FD1]" />
							) : null}
						</Button>
					</div>
					<div
			...
			<div className="relative flex flex-shrink-0 items-center px-1 py-1">
				<div className="z-10 flex min-w-0 flex-1 items-center gap-1.5">
					...
					<Button
						...
						variant="ghost"
						size="icon"
						className="h-7 w-7 rounded-full text-muted-foreground transition-all hover:bg-[#6D4FD1]/10 hover:text-[#6D4FD1]"
				...
				<div className="z-10 ml-auto flex items-center gap-2">
					<div className="flex items-center gap-1.5">
						...
						<div className="relative flex h-7 w-24 select-none items-center overflow-hidden rounded-full border border-foreground/[0.06] bg-editor-bg/80 shadow-[inset_0_1px_0_hsl(var(--foreground)/0.06)]">
							...
							/>
							<div
								className="pointer-events-none absolute bottom-[18%] top-[18%] z-10 w-0.5 rounded-full bg-foreground/95 shadow-[0_0_10px_rgba(109, 79, 209,0.28)]"
