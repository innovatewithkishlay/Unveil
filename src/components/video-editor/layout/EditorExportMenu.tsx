		...
		<DropdownMenu open={showExportDropdown} onOpenChange={setShowExportDropdown} modal={false}>
			<DropdownMenuTrigger asChild>
				<Button
					...
					className="inline-flex h-8 min-w-[112px] items-center justify-center gap-2 rounded-[5px] bg-[#6D4FD1] px-4.5 text-white transition-colors hover:bg-[#6D4FD1]/92"
				>
					...
					<div className="rounded-2xl border border-foreground/10 bg-editor-surface p-4 text-foreground shadow-2xl">
						...
						<div className="h-2 overflow-hidden rounded-full border border-foreground/5 bg-foreground/5">
							...
							isExportFinalSaveIndeterminate ? (
								...
								<div
									className="h-full bg-[#6D4FD1] transition-all duration-300 ease-out"
									style={{
						...
						<div className="mt-4 flex gap-2">
							{hasPendingExportSave ? (
								<Button
									...
									className="h-8 flex-1 rounded-[5px] bg-[#6D4FD1] text-xs font-semibold text-white hover:bg-[#6D4FD1]/92"
								>
